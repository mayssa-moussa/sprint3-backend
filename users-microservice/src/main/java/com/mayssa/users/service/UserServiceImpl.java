...
@Transactional // toutes les méthodes de cette classe sont transactionnelles(lancer save
				// automatiqument suit
				// à la modification des objets
@Service
public class UserServiceImpl implements UserService {
	...
	@Override
	public User registerUser(RegistationRequest request) throws EmailAlreadyExistsException {
